...
public class SportsHall extends BoosterBuilding{
    /**
     * This is the constructor for the SportsHall, just calls the constructor for BoosterBuilding via super, and then
     * sets the time to build and texture locations to predetermined ones.
